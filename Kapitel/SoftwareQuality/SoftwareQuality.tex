...
Softwaremetriken (SM) dienen in der Softwareentwicklung als Ansatzpunkt zur Bestimmung von Qualität. In einer SM werden Softwareeigenschaften Zahlen zugeordnet. Anhand der Zahlen lassen sich Rückschlüsse auf die Qualität der Software ziehen. Aspekten einer Softwaremetrik können z.B.~die Zahl der Verzweigungen im Quellcode oder die Komplexität der Vererbungshierarchie sein.~\cite[p.~3]{Committee1998}
...
In ~\cite{Pomorova2013} wird ein Versuch beschrieben in dem vier verschiedene Softwareprojekte mit dieser Methode eingeschätzt wurden. Dabei erzielte das System genaue Ergebnisse.\\
\\
